<header data-v-1def8f76="" data-v-6bbac5d6="" class="site-header ant-layout-header" id="header">
    <div data-v-1def8f76="" class="header-left">
        <ul data-v-1def8f76="" role="menu"
            ...
            <li data-v-1def8f76="" role="menuitem" class="ant-menu-item" style="font-size: 0px;"><img data-v-1def8f76=""
                    src="https://www.swensens1112.com/images/icon-scan-black.svg" alt="" class="icon"
        ...
        <div data-v-1def8f76="" class="location">
            <ul data-v-f89fbad4="" data-v-1def8f76="" role="menu"
                ...
                @if (!Auth::check())
                    <li data-v-f89fbad4="" role="menuitem" class="current-location ant-menu-item"><a data-v-f89fbad4=""
                            href="/address" class="">
                            <div data-v-f89fbad4="" class="menu-title-wrapper"><img data-v-f89fbad4=""
                                    src="https://www.swensens1112.com/images/icon-location.svg" alt=""
                                    class="icon" style="height: 24px; width: auto; margin-right: 8px;">
                                กรุณาเลือกที่อยู่จัดส่ง <i data-v-f89fbad4="" aria-label="icon: caret-down"
                                    class="anticon anticon-caret-down"
                                    style="margin-right: 0px; margin-left: auto;"><svg viewBox="0 0 1024 1024"
                                        data-icon="caret-down" width="1em" height="1em" fill="currentColor"
                    ...
                    <li role="menuitem" class="ant-menu-submenu ant-menu-submenu-horizontal ant-menu-overflowed-submenu"
                        style="visibility: hidden; position: absolute; display: none;">
                        <div aria-haspopup="true" class="ant-menu-submenu-title"><i class="ant-menu-submenu-arrow"></i>
                        </div>
                    </li>
                @endif
            </ul>
    ...
    <div data-v-1def8f76="" class="logo"><a data-v-1def8f76="" href="/" aria-current="page"
            class="nuxt-link-exact-active nuxt-link-active"><svg data-v-1def8f76="" width="103" height="26"
                viewBox="0 0 103 26" fill="none" xmlns="http://www.w3.org/2000/svg" class="swensens-logo">
    ...
    <div data-v-1def8f76="" class="header-right ant-space ant-space-horizontal ant-space-align-center">
        <div data-v-1def8f76="" class="ant-space-item" style="margin-right: 0px;">
            <div data-v-1def8f76="" class="header-actions">
                <div data-v-1def8f76="" class="action-list ant-space ant-space-horizontal ant-space-align-center">
                    <div data-v-1def8f76="" class="ant-space-item" style="margin-right: 24px;">
                        <ul data-v-f89fbad4="" data-v-1def8f76="" role="menu"
                            class="header-user-menu header-location-menu ant-menu ant-menu-horizontal ant-menu-root ant-menu-light">
                            <li role="menuitem"
                            ...
                            @if (!Auth::check())
                                <li data-v-f89fbad4="" role="menuitem" class="current-location ant-menu-item"><a
                                        data-v-f89fbad4="" href="/address" class="">
                                        <div data-v-f89fbad4="" class="menu-title-wrapper"><img data-v-f89fbad4=""
                                                src="https://www.swensens1112.com/images/icon-location.svg"
                                                alt="" class="icon"
                                                style="height: 24px; width: auto; margin-right: 8px;">
                                            กรุณาเลือกที่อยู่จัดส่ง <i data-v-f89fbad4=""
                                                aria-label="icon: caret-down" class="anticon anticon-caret-down"
                                                style="margin-right: 0px; margin-left: auto;"><svg
                                                    viewBox="0 0 1024 1024" data-icon="caret-down" width="1em"
                    ...
                    @if (Auth::check())
                        <div data-v-1def8f76="" class="ant-space-item" style="margin-right: 24px;"><a
                                data-v-1def8f76="" href="{{ route('backend.product.index') }}"
                                class="header-button ant-btn"><span>ระบบจัดการหลังบ้าน</span></a></div>
                        <div data-v-1def8f76="" class="ant-space-item" style="margin-right: 24px;"><a
                                data-v-1def8f76="" href="" class="header-button ant-btn"><span>สวัสดี ,
                                    {{ Auth::user()->email }}</span></a></div>
                    @else
                        <div data-v-1def8f76="" class="ant-space-item" style="margin-right: 24px;"><a
                                data-v-1def8f76="" href="/register"
                                class="header-button ant-btn"><span>สมัครสมาชิก</span></a></div>
                    @endif
                    @if (Auth::check())
                        <div data-v-1def8f76="" class="ant-space-item" style="margin-right: 24px;"><a
                                data-v-1def8f76="" href="{{ route('logout') }}"
                                onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"
                                class="header-button
                                ant-btn ant-btn-primary"><span>ออกจากระบบ</span></a>
                        </div>
                    ...
                    @else
                        <div data-v-1def8f76="" class="ant-space-item" style="margin-right: 24px;"><a
                                data-v-1def8f76="" href="/login"
                                class="header-button ant-btn ant-btn-primary"><span>เข้าสู่ระบบ</span></a>
                    @endif
                </div>
                <div data-v-1def8f76="" class="ant-space-item">
                    <ul data-v-1def8f76="" role="menu"
                        ...
                        <li data-v-1def8f76="" role="menuitem" class="ant-menu-submenu ant-menu-submenu-horizontal">
                            <div aria-haspopup="true" class="ant-menu-submenu-title"><span data-v-1def8f76=""
                                    class="submenu-title-wrapper">TH <i data-v-1def8f76=""
                                        aria-label="icon: caret-down" class="anticon anticon-caret-down"
                                        style="margin-right: 0px;"><svg viewBox="0 0 1024 1024"
                                            data-icon="caret-down" width="1em" height="1em" fill="currentColor"
                                            aria-hidden="true" focusable="false" class="">
                                            <path
                                                d="M840.4 300H183.6c-19.7 0-30.7 20.8-18.5 35l328.4 380.8c9.4 10.9 27.5 10.9 37 0L858.9 335c12.2-14.2 1.2-35-18.5-35z">
    ...
    <div data-v-1def8f76="" class="ant-space-item">
        <ul data-v-1def8f76="" role="menu"
            ...
            <li data-v-1def8f76="" role="menuitem" class="shopping-bag ant-menu-item" style="font-size: 0px;">
                <img data-v-1def8f76="" src="https://www.swensens1112.com/images/icon-bag.svg" alt=""
                    class="icon" style="height: 24px; width: auto;"> <!---->
            </li>
            <li role="menuitem" class="ant-menu-submenu ant-menu-submenu-horizontal ant-menu-overflowed-submenu"
                style="display: none;">
                <div aria-haspopup="true" class="ant-menu-submenu-title"><span> </span><i
            ...
            <li data-v-1def8f76="" role="menuitem" class="ant-menu-item" style="font-size: 0px; padding-left: 0px;">
                <img data-v-1def8f76="" src="https://www.swensens1112.com/images/menu.svg" alt=""
                    class="icon" style="height: 32px; width: auto;">
            </li>
            <li role="menuitem" class="ant-menu-submenu ant-menu-submenu-horizontal ant-menu-overflowed-submenu"
                style="visibility: hidden; position: absolute; display: none;">
                <div aria-haspopup="true" class="ant-menu-submenu-title"><span> </span><i
    ...
    <div>
        <div data-v-6bbac5d6="" tabindex="-1" class="ant-drawer ant-drawer-right  sidebar-drawer">
            <div class="ant-drawer-mask"></div>
            <div class="ant-drawer-content-wrapper" style="width: 320px; transform: translateX(100%); ">
                <div class="ant-drawer-content">
                    <div class="ant-drawer-wrapper-body">
                        <div class="ant-drawer-body" style="padding: 0px;">
                            <aside data-v-ef65d292="" data-v-6bbac5d6=""
                                class="page-sidebar ant-layout-sider ant-layout-sider-dark"
                                style="flex: 0 0 320px; max-width: 320px; min-width: 320px; width: 320px; background: rgb(255, 255, 255); padding: 16px 0px; min-height: calc(-72px + 100vh);">
                                <div class="ant-layout-sider-children">
                                    <div data-v-ef65d292="" class="welcome" style="padding-left: 24px;">
                                        <h2 data-v-ef65d292="" class="heading">ยินดีต้อนรับ ☺ 🍨️</h2>
                                        <h3 data-v-ef65d292="" class="name"> </h3>
                                    </div>
                                    <div data-v-ef65d292="" class="action-list  ant-space-vertical"
                                        style="    padding-left: 24px;
                                        padding-right: 24px;">
                                        <div data-v-ef65d292="" class="ant-space-item" style="margin-bottom: 16px;">
                                            <a data-v-ef65d292="" href="/register"
                                                class="header-button ant-btn ant-btn-block"><span>สมัครสมาชิก</span></a>
                                        </div>
                                        <div data-v-ef65d292="" class="ant-space-item"><a data-v-ef65d292=""
                                                href="/login"
                                                class="header-button ant-btn ant-btn-primary ant-btn-block"><span>เข้าสู่ระบบ</span></a>
                                        </div>
                                    </div>
                                </div>
                            </aside>
